 ...
 * completely initalized, and the OpenSearch {@link org.opensearch.client.Client}, {@link
...
public class SampleJobRunner implements ScheduledJobRunner {
  ...
  public void runJob(ScheduledJobParameter jobParameter, JobExecutionContext context) {
    if (!(jobParameter instanceof SampleJobParameter)) {
      throw new IllegalStateException(
          "Job parameter is not instance of SampleJobParameter, type: "
  ...
  private void runTaskForLockIntegrationTests(SampleJobParameter jobParameter)
